...
def update_json_file():
    ...
    general_pastes_url = 'https://raw.githubusercontent.com/NekroMonger25/MammaMia/refs/heads/local/domain.txt'
...
if __name__ == '__main__':
    update_json_file()        print("⚡ File config.json aggiornato con successo! AMEN!")
    except Exception as e:
        print(f"Errore durante il salvataggio del file JSON: {e}")
